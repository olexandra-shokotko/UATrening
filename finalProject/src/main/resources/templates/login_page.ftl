...
<div class="container" style="margin-top: 60px">
    <div class="row">
        <div class="col-md-8 col-md-offset-2">
            ...
            <form id="loginForm" action="/login" method="post" style="margin-bottom: 30px" name="form" autocomplete="off" novalidate>
                ...
                <button id="sendForm" type="submit" class="btn btn-success" style="margin-top:30px" >
                    Submit
                </button>
            </form>
        </div>
